...
export default memo(function RutaPerformance({ porRuta }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/70 dark:border-slate-700/70 p-5 shadow-card">
      <div className="mb-4">
        <h3 className="font-bold text-slate-900 dark:text-slate-100">Rendimiento por ruta</h3>
        <p className="text-xs text-slate-500 dark:text-slate-400">Cobrado total acumulado</p>
      </div>
        ...
        {porRuta.map((r) => (
          <div key={r.id}>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-sm font-bold text-slate-900 dark:text-slate-100 tabular-nums flex-shrink-0">
            ...
            <div className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 tabular-nums">
